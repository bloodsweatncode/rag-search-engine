...
def main() -> None:
    ...
    idf_parser = subparsers.add_parser("idf", help="Get term frequency for a given document ID and term")
    idf_parser.add_argument("term", type=str, help="Term to get frequency for")

    tf_idf_parser = subparsers.add_parser("tfidf", help="Get term frequency for a given document ID and term")
